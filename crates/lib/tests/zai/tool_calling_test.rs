//! # ZAI Tool Calling Tests
//!
//! This file contains tests for the ZAI provider's tool calling functionality.
...
fn test_zai_provider_creation() {
    ...
    tokio::runtime::Runtime::new().unwrap().block_on(async {
        let client = providers::zai::Client::builder("test-key").build();
        let completion_model = client.completion_model(providers::zai::GLM_4_6);

        // Create agent with tools
        let agent = completion_model
            .agent(providers::zai::GLM_4_6)
