# Code Examples for tursodatabase-turso (Version: v0.2.0-pre.3)
...
```
---
## `test:tests/integration/query_processing/test_transactions.rs:test_deferred_transaction_no_restart`
**Source:** `tests/integration/query_processing/test_transactions.rs` (`test`)
...
```
---
## `test:tests/integration/query_processing/test_transactions.rs:test_deferred_transaction_restart`
**Source:** `tests/integration/query_processing/test_transactions.rs` (`test`)
...
```
---
## `test:tests/integration/query_processing/test_transactions.rs:test_mvcc_insert_select_basic`
**Source:** `tests/integration/query_processing/test_transactions.rs` (`test`)
...
```
---
## `test:tests/integration/query_processing/test_transactions.rs:test_mvcc_transactions_autocommit`
**Source:** `tests/integration/query_processing/test_transactions.rs` (`test`)
...
```
---
## `test:tests/integration/query_processing/test_transactions.rs:test_mvcc_transactions_deferred`
**Source:** `tests/integration/query_processing/test_transactions.rs` (`test`)
...
```
---
## `test:tests/integration/query_processing/test_transactions.rs:test_mvcc_transactions_immediate`
**Source:** `tests/integration/query_processing/test_transactions.rs` (`test`)
...
```
---
## `test:tests/integration/query_processing/test_transactions.rs:test_mvcc_update_basic`
**Source:** `tests/integration/query_processing/test_transactions.rs` (`test`)
